import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as i,a as e,o as r}from"./app-CGk8ZzeL.js";const a="/screenshot/ds/image-61.png",l="/screenshot/ds/image-63.png",s="/screenshot/ds/image-55.png",o="/screenshot/ds/image-56.png",d="/screenshot/ds/image-57.png",c="/screenshot/ds/image-58.png",p="/screenshot/ds/image-59.png",m="/screenshot/ds/image-60.png",g="/screenshot/ds/image-64.png",u="/screenshot/ds/image-65.png",h="/screenshot/ds/image-67.png",f="/screenshot/ds/image-66.png",b={};function x(_,n){return r(),i("div",null,[...n[0]||(n[0]=[e('<h2 id="二分查找算法" tabindex="-1"><a class="header-anchor" href="#二分查找算法"><span>二分查找算法</span></a></h2><p><strong>在有序数组中查找值</strong></p><blockquote><p>数组和函数之间没有本质差别<br> 数组消耗空间，函数消耗时间<br> 因此在底层数组和函数没有区别，也就意味着二分查找算法可以应用于函数<br><strong>不仅可以应用在有序数组上，也可以作用在单调函数上</strong></p></blockquote><h3 id="二分查找泛型情况" tabindex="-1"><a class="header-anchor" href="#二分查找泛型情况"><span>二分查找泛型情况</span></a></h3><p><strong>头尾指针重合位置就是所要查找的位置</strong><br><img src="'+a+`" alt="alt text" loading="lazy"></p><ul><li>查找第一个1</li><li><pre><code>  while(head &lt; tail)
  {
      mid = (head + tail) / 2;
...
</code></pre></li></ul><h3 id="搜索插入位置" tabindex="-1"><a class="header-anchor" href="#搜索插入位置"><span>搜索插入位置</span></a></h3><figure><img src="`+d+`" alt="alt text" tabindex="0" loading="lazy"><figcaption>alt text</figcaption></figure><ul><li><p>也可以用二分算法的泛型情况来写</p><pre><code>  class Solution {
  public:
...
</code></pre></li></ul><h3 id="存在重复元素" tabindex="-1"><a class="header-anchor" href="#存在重复元素"><span>存在重复元素</span></a></h3><figure><img src="`+c+`" alt="alt text" tabindex="0" loading="lazy"><figcaption>alt text</figcaption></figure><ul><li><p>个人做法：</p></li><li><p>先对下标数组排序，然后从前往后遍历数组，看是否出现过相同数字</p><pre><code>  class Solution {
  public:
...
</code></pre></li></ul><h3 id="两个数组的交集" tabindex="-1"><a class="header-anchor" href="#两个数组的交集"><span>两个数组的交集</span></a></h3><figure><img src="`+p+`" alt="alt text" tabindex="0" loading="lazy"><figcaption>alt text</figcaption></figure><ul><li><p>将某个数组插入哈希表</p></li><li><p>利用set特性可以剔除相同的数字</p></li><li><p>查找到就插入结果数组</p><pre><code>  class Solution {
  public:
...
</code></pre>`,46)])])}const z=t(b,[["render",x]]),j=JSON.parse('{"path":"/ds/%E6%9F%A5%E6%89%BE%E7%AE%97%E6%B3%95.html","title":"查找算法","lang":"zh-CN","frontmatter":{"title":"查找算法","author":"xbZhong","isOriginal":true,"article":false,"category":"ds","timeline":true,"icon":"mingcute:code-line","description":"二分查找算法 在有序数组中查找值 数组和函数之间没有本质差别 数组消耗空间，函数消耗时间 因此在底层数组和函数没有区别，也就意味着二分查找算法可以应用于函数 不仅可以应用在有序数组上，也可以作用在单调函数上 二分查找泛型情况 头尾指针重合位置就是所要查找的位置 alt text 查找第一个1 alt textalt text 查找最后一个1 跳跃表 每...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"WebPage\\",\\"name\\":\\"查找算法\\",\\"description\\":\\"二分查找算法 在有序数组中查找值 数组和函数之间没有本质差别 数组消耗空间，函数消耗时间 因此在底层数组和函数没有区别，也就意味着二分查找算法可以应用于函数 不仅可以应用在有序数组上，也可以作用在单调函数上 二分查找泛型情况 头尾指针重合位置就是所要查找的位置 alt text 查找第一个1 alt textalt text 查找最后一个1 跳跃表 每...\\"}"],["meta",{"property":"og:url","content":"https://xbzhong.cn/ds/%E6%9F%A5%E6%89%BE%E7%AE%97%E6%B3%95.html"}],["meta",{"property":"og:site_name","content":"阿b的博客"}],["meta",{"property":"og:title","content":"查找算法"}],["meta",{"property":"og:description","content":"二分查找算法 在有序数组中查找值 数组和函数之间没有本质差别 数组消耗空间，函数消耗时间 因此在底层数组和函数没有区别，也就意味着二分查找算法可以应用于函数 不仅可以应用在有序数组上，也可以作用在单调函数上 二分查找泛型情况 头尾指针重合位置就是所要查找的位置 alt text 查找第一个1 alt textalt text 查找最后一个1 跳跃表 每..."}],["meta",{"property":"og:type","content":"website"}],["meta",{"property":"og:image","content":"https://xbzhong.cn/screenshot/ds/image-61.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2025-10-10T12:45:16.000Z"}],["meta",{"property":"article:author","content":"xbZhong"}],["meta",{"property":"article:modified_time","content":"2025-10-10T12:45:16.000Z"}]]},"git":{"createdTime":1760100316000,"updatedTime":1760100316000,"contributors":[{"name":"BO","username":"BO","email":"2396768163@qq.com","commits":1,"url":"https://github.com/BO"}]},"readingTime":{"minutes":7.37,"words":2212},"filePathRelative":"ds/查找算法.md","excerpt":"<h2>二分查找算法</h2>\\n<p><strong>在有序数组中查找值</strong></p>\\n<blockquote>\\n<p>数组和函数之间没有本质差别<br>\\n数组消耗空间，函数消耗时间<br>\\n因此在底层数组和函数没有区别，也就意味着二分查找算法可以应用于函数<br>\\n<strong>不仅可以应用在有序数组上，也可以作用在单调函数上</strong></p>\\n</blockquote>\\n<h3>二分查找泛型情况</h3>\\n<p><strong>头尾指针重合位置就是所要查找的位置</strong><br>\\n<img src=\\"/screenshot/ds/image-61.png\\" alt=\\"alt text\\" loading=\\"lazy\\"></p>","autoDesc":true}');export{z as comp,j as data};
