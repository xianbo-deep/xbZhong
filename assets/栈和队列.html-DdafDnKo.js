import{_ as t,c as i,a as e,o as l}from"./app-C9dr6Ulr.js";const r="/xbZhong/screenshot/ds/image-9.png",a="/xbZhong/screenshot/ds/image-20.png",s="/xbZhong/screenshot/ds/image-10.png",p="/xbZhong/screenshot/ds/image-12.png",o="/xbZhong/screenshot/ds/image-15.png",c="/xbZhong/screenshot/ds/image-16.png",u="/xbZhong/screenshot/ds/image-17.png",g="/xbZhong/screenshot/ds/image-18.png",m="/xbZhong/screenshot/ds/image-19.png",d={};function h(f,n){return l(),i("div",null,[...n[0]||(n[0]=[e('<p><a href="/pdfs/ds/%E6%A0%88%E5%92%8C%E9%98%9F%E5%88%97.pdf" target="_blank" rel="noopener noreferrer">本页PDF</a></p><h2 id="括号匹配" tabindex="-1"><a class="header-anchor" href="#括号匹配"><span>括号匹配</span></a></h2><p><img src="'+r+`" alt="alt text" loading="lazy"><br><em><strong>用栈来模拟括号匹配的过程</strong></em><br><strong>用栈是因为栈可以解决具有完全包含关系的问题</strong></p><pre><code>#include&lt;bits/stdc++.h&gt;
using namespace std;
int main()
{
int n;
...
</code></pre></li></ul><h2 id="比较含退格的字符串" tabindex="-1"><a class="header-anchor" href="#比较含退格的字符串"><span>比较含退格的字符串</span></a></h2><p><img src="`+s+`" alt="alt text" loading="lazy"><br><strong>使用栈的思想</strong></p><ul><li><p>遇到#就出栈，否则就入栈</p></li><li><p>比较俩栈的字符</p><pre><code>  class Solution {
  public:
