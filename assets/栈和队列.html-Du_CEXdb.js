import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as i,e,o as l}from"./app-1qWqKpNW.js";const r="/screenshot/ds/image-9.png",s="/screenshot/ds/image-20.png",a="/screenshot/ds/image-10.png",p="/screenshot/ds/image-12.png",o="/screenshot/ds/image-15.png",c="/screenshot/ds/image-16.png",u="/screenshot/ds/image-17.png",g="/screenshot/ds/image-18.png",m="/screenshot/ds/image-19.png",d={};function f(h,n){return l(),i("div",null,[...n[0]||(n[0]=[e('<h2 id="括号匹配" tabindex="-1"><a class="header-anchor" href="#括号匹配"><span>括号匹配</span></a></h2><p><img src="'+r+`" alt="alt text" loading="lazy"><br><em><strong>用栈来模拟括号匹配的过程</strong></em><br><strong>用栈是因为栈可以解决具有完全包含关系的问题</strong></p><pre><code>#include&lt;bits/stdc++.h&gt;
using namespace std;
int main()
{
int n;
