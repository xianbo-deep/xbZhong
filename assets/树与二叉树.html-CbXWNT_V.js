import{_ as t,c as e,a as r,o}from"./app-B4g127w4.js";const i="/screenshot/ds/image-21.png",l="/screenshot/ds/image-22.png",a="/screenshot/ds/image-23.png",d="/screenshot/ds/image-25.png",s="/screenshot/ds/image-26.png",c="/screenshot/ds/image-27.png",p="/screenshot/ds/image-28.png",g="/screenshot/ds/image-29.png",u="/screenshot/ds/image-30.png",h="/screenshot/ds/image-31.png",f="/screenshot/ds/image-32.png",b={};function m(N,n){return o(),e("div",null,[...n[0]||(n[0]=[r(`<p><a href="/pdfs/ds/%E6%A0%91%E4%B8%8E%E4%BA%8C%E5%8F%89%E6%A0%91.pdf">本页PDF</a></p><h2 id="树" tabindex="-1"><a class="header-anchor" href="#树"><span>树</span></a></h2><p><strong>树的节点代表集合，树的边代表关系</strong></p><h3 id="广度优先遍历" tabindex="-1"><a class="header-anchor" href="#广度优先遍历"><span>广度优先遍历</span></a></h3><ul><li><p>也叫做层序遍历，一层一层来遍历树</p></li><li><p>使用队列来进行遍历，遍历完当前节点的子节点就弹出该节点</p><pre><code>  void bfs(Node *root) //广度优先遍历
  {
      head = tail = 0;
      Queue[tail++] = root;
      while(head&lt;tail)
...
</code></pre>`,52)])])}const v=t(b,[["render",m]]),L=JSON.parse('{"path":"/ds/%E6%A0%91%E4%B8%8E%E4%BA%8C%E5%8F%89%E6%A0%91.html","title":"树","lang":"zh-CN","frontmatter":{"title":"树","author":"xbZhong","isOriginal":true,"article":false,"category":"ds","timeline":true,"description":"本页PDF 树 树的节点代表集合，树的边代表关系 广度优先遍历 也叫做层序遍历，一层一层来遍历树 使用队列来进行遍历，遍历完当前节点的子节点就弹出该节点 深度优先遍历 使用栈来实现遍历 先左后右 判断栈顶元素是否有子节点，有子节点则入栈，无子节点则出栈，直到变为空栈 二叉树性质 度为0的节点比度为2的节点多一个 种类 完全二叉树：只有最后一层缺少右侧节...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"WebPage\\",\\"name\\":\\"树\\",\\"description\\":\\"本页PDF 树 树的节点代表集合，树的边代表关系 广度优先遍历 也叫做层序遍历，一层一层来遍历树 使用队列来进行遍历，遍历完当前节点的子节点就弹出该节点 深度优先遍历 使用栈来实现遍历 先左后右 判断栈顶元素是否有子节点，有子节点则入栈，无子节点则出栈，直到变为空栈 二叉树性质 度为0的节点比度为2的节点多一个 种类 完全二叉树：只有最后一层缺少右侧节...\\"}"],["meta",{"property":"og:url","content":"https://xbzhong.cn/ds/%E6%A0%91%E4%B8%8E%E4%BA%8C%E5%8F%89%E6%A0%91.html"}],["meta",{"property":"og:site_name","content":"阿b的博客"}],["meta",{"property":"og:title","content":"树"}],["meta",{"property":"og:description","content":"本页PDF 树 树的节点代表集合，树的边代表关系 广度优先遍历 也叫做层序遍历，一层一层来遍历树 使用队列来进行遍历，遍历完当前节点的子节点就弹出该节点 深度优先遍历 使用栈来实现遍历 先左后右 判断栈顶元素是否有子节点，有子节点则入栈，无子节点则出栈，直到变为空栈 二叉树性质 度为0的节点比度为2的节点多一个 种类 完全二叉树：只有最后一层缺少右侧节..."}],["meta",{"property":"og:type","content":"website"}],["meta",{"property":"og:image","content":"https://xbzhong.cn/screenshot/ds/image-21.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-03-06T10:39:39.000Z"}],["meta",{"property":"article:author","content":"xbZhong"}],["meta",{"property":"article:modified_time","content":"2026-03-06T10:39:39.000Z"}]]},"git":{"createdTime":1772793579000,"updatedTime":1772793579000,"contributors":[{"name":"BO","username":"BO","email":"2396768163@qq.com","commits":1,"url":"https://github.com/BO"}]},"readingTime":{"minutes":10.55,"words":3164},"filePathRelative":"ds/树与二叉树.md","excerpt":"<p><a href=\\"/pdfs/ds/%E6%A0%91%E4%B8%8E%E4%BA%8C%E5%8F%89%E6%A0%91.pdf\\">本页PDF</a></p>\\n<h2>树</h2>\\n<p><strong>树的节点代表集合，树的边代表关系</strong></p>\\n<h3>广度优先遍历</h3>\\n<ul>\\n<li>\\n<p>也叫做层序遍历，一层一层来遍历树</p>\\n</li>\\n<li>\\n<p>使用队列来进行遍历，遍历完当前节点的子节点就弹出该节点</p>\\n<pre><code>  void bfs(Node *root) //广度优先遍历\\n  {\\n      head = tail = 0;\\n      Queue[tail++] = root;\\n      while(head&lt;tail)\\n      {\\n          Node *node = Queue[head];\\n          cout &lt;&lt; node-&gt;key &lt;&lt; endl;\\n          if(node-&gt;lchild) Queue[tail++] = node-&gt;lchild;\\n          if(node-&gt;rchild) Queue[tail++] = node-&gt;rchild;\\n          head++;\\n      }\\n      return;\\n  }\\n</code></pre>\\n</li>\\n</ul>","autoDesc":true}');export{v as comp,L as data};
