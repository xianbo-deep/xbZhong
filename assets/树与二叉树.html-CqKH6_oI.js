import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as e,e as r,o}from"./app-DSpxlwYV.js";const i="/screenshot/ds/image-21.png",l="/screenshot/ds/image-22.png",a="/screenshot/ds/image-23.png",d="/screenshot/ds/image-25.png",s="/screenshot/ds/image-26.png",c="/screenshot/ds/image-27.png",p="/screenshot/ds/image-28.png",g="/screenshot/ds/image-29.png",u="/screenshot/ds/image-30.png",h="/screenshot/ds/image-31.png",f="/screenshot/ds/image-32.png",b={};function m(N,n){return o(),e("div",null,[...n[0]||(n[0]=[r(`<h2 id="树" tabindex="-1"><a class="header-anchor" href="#树"><span>树</span></a></h2><p><strong>树的节点代表集合，树的边代表关系</strong></p><h3 id="广度优先遍历" tabindex="-1"><a class="header-anchor" href="#广度优先遍历"><span>广度优先遍历</span></a></h3><ul><li><p>也叫做层序遍历，一层一层来遍历树</p></li><li><p>使用队列来进行遍历，遍历完当前节点的子节点就弹出该节点</p><pre><code>  void bfs(Node *root) //广度优先遍历
  {
      head = tail = 0;
      Queue[tail++] = root;
      while(head&lt;tail)
