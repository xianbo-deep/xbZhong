import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as t,e as a,o as i}from"./app-oGawE8L1.js";const r="/screenshot/ds/image-6.png",p="/screenshot/ds/image-3.png",o="/screenshot/ds/image-4.png",s="/screenshot/ds/image-5.png",l="/screenshot/ds/image-7.png",d="/screenshot/ds/image-8.png",h={};function c(g,e){return i(),t("div",null,[...e[0]||(e[0]=[a('<h2 id="反转链表" tabindex="-1"><a class="header-anchor" href="#反转链表"><span>反转链表</span></a></h2><figure><img src="'+r+`" alt="alt text" tabindex="0" loading="lazy"><figcaption>alt text</figcaption></figure><h3 id="反转链表迭代做法" tabindex="-1"><a class="header-anchor" href="#反转链表迭代做法"><span>反转链表迭代做法</span></a></h3><p><strong>通过创建一个新的节点prev，将旧链表从前往后遍历</strong></p><pre><code>class Solution {
public:
