...
- APB：高级外设总线，支持**一主多从**，**低成本、低功耗、结构简单**
  - APB1：连接低速外设
  - APB2：连接高速外设，频率更高
...
CoreSight调试架构包括**调试接口协议、调试总线协议、对调试组件的控制、安全特性、跟踪接口**
...
针对ARM内核的主流集成开发环境主要有**Keil MDK和IAR EWARM**
...
![](/myMajor/note/image-20251231155824137.png)

- $\Delta - \sum$使用了**过采样和噪声整形**技术
...
集成有三个12位**逐次逼近型**的A/D转换器，ADC1和ADC3能产生DMA请求
